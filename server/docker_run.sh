...
docker run --rm   --name pg-docker -e POSTGRES_PASSWORD=docker -d -p 5432:5432 -v /Users/vproskurin/work/js_Projects/learning/react/react-express-todo/server/data:/var/lib/postgresql/data  postgres
echo Container Up
